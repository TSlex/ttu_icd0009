...
namespace WebApp.ApiControllers._1._0.Admin
{
    ...
    public class AdminPostsController : ControllerBase
    {
        ...
        private readonly DTOMapper<Post, PostAdminDTO> _mapper;

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="bll">Application Bll</param>
        public AdminPostsController(IAppBLL bll)
        {
            _bll = bll;
        ...
        {
            var record = await _bll.Posts.FindAdminAsync(id);
        ...
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(PostAdminDTO))]
        ...
        public async Task<IActionResult> Create([FromBody] PostAdminDTO model)
        {
            ...
            if (TryValidateModel(model))
            {
                ...
                _bll.Posts.Add(_mapper.MapReverse(model));
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(ErrorResponseDTO))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ErrorResponseDTO))]
        public async Task<IActionResult> Edit(Guid id, [FromBody] PostAdminDTO model)
        {
            if (id != model.Id)
            {
            ...
            {
                await _bll.Posts.UpdateAsync(_mapper.MapReverse(model));
                await _bll.SaveChangesAsync();
