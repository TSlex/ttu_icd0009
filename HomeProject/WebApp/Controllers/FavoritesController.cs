...
namespace WebApp.Controllers
{
    public class FavoritesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FavoriteId,ProfileId,PostId")] Favorite favorite)
        {
            ...
            ViewData["PostId"] = new SelectList(_context.Posts, "PostId", "PostId", favorite.PostId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("FavoriteId,ProfileId,PostId")] Favorite favorite)
        {
