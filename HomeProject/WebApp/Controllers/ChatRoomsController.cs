    ...
    public class ChatRoomsController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var chatRoom = await _context.Rooms
                .FirstOrDefaultAsync(m => m.ChatRoomId == id);
            if (chatRoom == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("ChatRoomId,ChatRoomTitle,LastMessageValue,LastMessageDateTime")] ChatRoom chatRoom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ChatRoomId,ChatRoomTitle,LastMessageValue,LastMessageDateTime")] ChatRoom chatRoom)
        {
        ...
        {
            return _context.Rooms.Any(e => e.ChatRoomId == id);
        }
    }
}
